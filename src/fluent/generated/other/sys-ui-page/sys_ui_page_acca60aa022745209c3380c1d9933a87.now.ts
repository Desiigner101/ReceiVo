...
UiPage({
    $id: Now.ID['acca60aa022745209c3380c1d9933a87'],
    category: 'general',
...
window.g_ck = "$[gs.getSession().getSessionToken() || gs.getSessionToken()]";</script>
    ...
    <script src="/uxasset/externals/x_1984201_receivo/main.jsdbx?uxpcb=$[UxFrameworkScriptables.getFlushTimestamp()]" type="module"></script>
  </head>
  <body>
    <div id="root"></div>
  </body>
